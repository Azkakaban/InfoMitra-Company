export function InputBox({ variant = "bold", type = "text", placeholder, value, onChange, judul, id, name, className = "", ...props }) {
    const styles = {
        ...
        // style lain
        soft: "w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all placeholder-gray-400 hover:bg-white"
    };
...
export function SelectBox({ variant = "soft", judul, value, onChange, name, options }) {
    const styles = {
        ...
        soft: "w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none appearance-none text-gray-700 cursor-pointer hover:bg-white transition-all"
    };
